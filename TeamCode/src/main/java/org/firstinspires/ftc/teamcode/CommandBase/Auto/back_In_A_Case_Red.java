...
@Autonomous(name = "back_In_A_Case_RED")
public class back_In_A_Case_Red extends OpModeEX {
    ...
    @Override
    public void initEX() {
        // startPosition: X is mirrored (360-169=191), Heading is mirrored (360-350=10)
        ...
        // Vision and Dashboard setup same as Blue...
    ...
    public void loopEX() {
        ...
        // ... logic for intakeOff/ballShot remains same ...

        if (visionCollect){
            // Heading PID remains negative because processor hAngle is local to camera
        ...
        switch (state) {
            case preLoad:
                // Logic same, just uses mirrored path "shoot"
            ...
            case collect1:
                // Mirrored Trigger: Blue X < 65 becomes Red X > 295 (360-65)
                if (pathing && odometry.X() > 295){
                    targetHeading = 90; // Mirrored 270
                ...
                if (pathing && follow.isFinished(10, 10)){
                    ...
                    follow.usePathHeadings(true);
                    follow.setHeadingOffset(-90); // Mirrored -90
                }
                break;
            ...
            case driveToShoot3:
                if (follow.isFinished(15,15) && !built && (shootTime.milliseconds() > shootWait || ballShot)){
                    ...
                    targetHeading = 140; // Mirrored 220 (360-220)
                    follow.setHeadingOffset(90); // Mirrored 90
            ...
            case firstBackCollect:
                if (built && (maxWait.milliseconds() > 2200 || intake.ballCount > 2)){
                    ...
                    visionCollect = false;
                    targetHeading = 80; // Mirrored 280 (360-280)
