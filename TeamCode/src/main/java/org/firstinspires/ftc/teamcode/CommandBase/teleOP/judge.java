...
public class judge extends OpModeEX {
    ...
    @Override
    public void initEX() {
        odometry.startPosition(0, 140, 10);
    ...
    public void loopEX() {
        ...
        driveBase.drivePowers(-gamepad1.right_stick_y, (gamepad1.left_trigger - gamepad1.right_trigger),
                -gamepad1.right_stick_x);
