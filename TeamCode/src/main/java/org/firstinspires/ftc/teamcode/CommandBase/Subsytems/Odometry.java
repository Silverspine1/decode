...
public class Odometry extends SubSystem {
    ...
    public void init() {
        ...
        /*
         * Another new feature to the Pinpoint is on-device error detection. This allows
         * the device
         * to ensure that the most recent read hasn't been corrupted. We use CRC8 error
         * detection
         * which is a lightweight, and accurate option. The sending device does a
         * polynomial division
         * on the contents of the transmission, and sends the result of that calculation
         * along with
         * the data. The receiving device then repeats that calculation and compares it.
         * If the two
        ...
        /*
         * Set the odometry pod positions relative to the point that the odometry
         * computer tracks around.
         * The X pod offset refers to how far sideways from the tracking point the
         * X (forward) odometry pod is. Left of the center is a positive number,
         * right of center is a negative number. the Y pod offset refers to how far
         * forwards from
         * the tracking point the Y (strafe) odometry pod is. forward of center is a
         * positive number,
        ...
        /*
         * Set the kind of pods used by your robot. If you're using goBILDA odometry
         * pods, select either
         * the goBILDA_SWINGARM_POD, or the goBILDA_4_BAR_POD.
         * If you're using another kind of odometry pod, uncomment setEncoderResolution
         * and input the
        ...
        /*
         * Set the direction that each of the two odometry pods count. The X (forward)
         * pod should
         * increase when you move the robot forward. And the Y (strafe) pod should
         * increase when
        ...
        /*
         * Before running the robot, recalibrate the IMU. This needs to happen when the
         * robot is stationary
         * The IMU will automatically calibrate when first powered on, but recalibrating
         * before running
         * the robot is a good idea to ensure that the calibration is "good".
         * resetPosAndIMU will reset the position to 0,0,0 and also recalibrate the IMU.
         * This is recommended before you run your autonomous, as a bad initial
         * calibration can cause
